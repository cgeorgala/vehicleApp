...
INSERT INTO users (
  first_name, last_name, email, username, password, role, position, registrationcode
) 
VALUES ( 
  'maria', 'papadopoulou', 'vehicle.app.hua@gmail.com', 'mariap','maria123', 'employee', 'HR', '123456789'
);

-- Create user CITIZEN-1
INSERT INTO users (
  first_name, last_name, email, username, password, role, position, registrationcode
)
VALUES ( 
  'giannis', 'vasilopoulos', 'vehicle.user2.hua@gmail.com', 'giannis','giannis123', 'citizen', 'Driver', '333456789'
);

-- Create user CITIZEN-2
INSERT INTO users (
  first_name, last_name, email, username, password, role, position, registrationcode
) 
VALUES (
  'eleni', 'ioannou', 'vehicle.user.hua@gmail.com', 'ellenk', 'ellen123', 'citizen', 'Sales', '223456789'
);  