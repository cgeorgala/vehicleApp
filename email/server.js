...
app.post('/notifyUser/', (req,res) =>
{
    if (req.body)
    {
        ...
        let email_options = {
            ...
            to: `${mail}`,
            subject: 'Ενημέρωση για την αίτηση μεταβίβασης οχήματος',
            html: `<p>Αγαπητέ πολίτη, <br/><br/>
                      Η αίτηση μεταβίβασης του οχήματος με αριθμό κυκλοφορίας 
                      <i><b>${veh_num}<b></i>, άλλαξε κατάσταση και  
                      <i><b>${status == "Rejected"
                      ? "απορρίπτεται."
                      : "ολοκληρώθηκε."
                      }</b></i><br/><br/>
                      Εκ μέρους της ομάδας μεταβίβασης οχημάτων
                    </p>`
        }
        // Send email
